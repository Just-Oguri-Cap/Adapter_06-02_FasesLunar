...
public class RelatorioAdpterLegado implements GerarRelatorio {
    private final RelatorioLegado relatorioLegado;
    public RelatorioAdpterLegado() {
        relatorioLegado = new RelatorioLegado();
    }

    // Converte o Double diaDoCiclo em FaseLunar permitindo o resto do programa usar o RelatórioCientifico
    @Override
